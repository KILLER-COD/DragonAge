...
public class UI {
	...
	public void creatMenu(String name, int x, int y, int width, int height, int optionsWidth, int optionsHeight){
	...
	public static class UI_String{
		...
		public void drawString(float x,float y,String  text, Color color){
			awtFont = new Font("Times New Roman" ,Font.BOLD, 62);
			font = new TrueTypeFont(awtFont, false);
